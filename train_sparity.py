...
from models.common import Bottleneck, GhostConv
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp-ECA-FPN-Ghost/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--single-cls', action='store_true', default=True, help='train multi-class data as single-class')
