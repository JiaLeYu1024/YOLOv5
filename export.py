...
Usage:
    ...
    $ python export.py --weights yolov5-ECA-FPN-Ghost_openvino_model --include openvino
Inference:
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp-0.1-797/weights/best.pt', help='model.pt path(s)')
